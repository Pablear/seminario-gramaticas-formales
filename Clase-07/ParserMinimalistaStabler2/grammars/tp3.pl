...
['-aron']::[=>v,'T'].              % El operador => No induce el movimiento de nucleo de v a T % Sin -nom, para evitar el movimiento y permitir la focalizacion.
...
['-aban']::[=>v,'T'].              % El operador => induce el movimiento de nucleo de v a T % Sin -nom, para evitar el movimiento y permitir la focalizacion.
